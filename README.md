...
| | O que é | Onde |
|---|---|---|
| Contexto do Trabalho 1 | as regras de vazamento, a auditoria mínima do **seu** dado, os baselines e o exemplo da aula — feito para colar no seu agente | [`CONTEXTOTRABALHO1.md`](CONTEXTOTRABALHO1.md) |
